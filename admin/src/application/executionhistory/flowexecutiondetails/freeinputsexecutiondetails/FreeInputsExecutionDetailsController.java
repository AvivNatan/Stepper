package application.executionhistory.flowexecutiondetails.freeinputsexecutiondetails;

import application.executionhistory.flowexecutiondetails.FlowExecutionDescriptionController;
import application.executionhistory.flowexecutiondetails.freeinputexecutiondetails.FreeInputExecutionDetailsController;
...
public class FreeInputsExecutionDetailsController {
    ...
    public void addTitleFreeInput(DtoFreeInputOutputExecution dto)
    {
        try
        {
            FXMLLoader loader=new FXMLLoader(getClass().getResource("/application/executionhistory/flowexecutiondetails/freeinputexecutiondetails/FreeInputExecutionDetails.fxml"));
