package application.executionhistory.flowexecutiondetails.outputsexecutiondetails;

import application.executionhistory.flowexecutiondetails.FlowExecutionDescriptionController;
import application.executionhistory.flowexecutiondetails.outputexecutiondetails.OutputExecutionDescriptionController;
...
public class OutputsExecutionDescriptionController {
    ...
    public void addTitleOutput(DtoFreeInputOutputExecution dto)
    {
        try
        {
            FXMLLoader loader=new FXMLLoader(getClass().getResource("/application/executionhistory/flowexecutiondetails/outputexecutiondetails/OutputExecutionDescription.fxml"));
