package application.mainappclient.flowexecution.flowexecutiondetails.stepsexecutiondetails;

import application.mainappclient.flowexecution.flowexecutiondetails.FlowExecutionDescriptionController;
import application.mainappclient.flowexecution.flowexecutiondetails.stepexecutiondetails.StepExecutionDescriptionController;
...
public class StepsExecutionDescriptionController {
    ...
    public void addTitleStep(DtoStepExecution dto)
    {
            try
            {
                FXMLLoader loader=new FXMLLoader(getClass().getResource("/application/mainappclient/flowexecution/flowexecutiondetails/stepexecutiondetails/StepExecutionDescription.fxml"));
