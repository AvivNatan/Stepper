package application.mainappclient.flowexecution.stepexecutiondetails.inputoutputstepExecution;
...
public class InputOutputStepExecutionController {
    ...
    public void setContent(Object content, GridPane grid) {
        ...
        if (content == null) {
            ...
            if (Objects.equals(type, "RelationData")) {
                ...
                for (Map.Entry<Object, Object> entry : ((Map<Object, Object>) content).entrySet())
                {
                    ...
                    res.append("car: ").append("<").append(entry.getKey().toString()).append(">").append("\n");
                    res.append("cdr: ").append("<").append(entry.getValue().toString()).append(">").append("\n");
                }
